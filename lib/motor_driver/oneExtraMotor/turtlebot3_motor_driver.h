...
#define DXL_THIRD_ID                    4       // ID of additional motor [third motor]
...
class Turtlebot3MotorDriver
{
 public:
  ...
  bool writeSingleVelocity(const float wheel_radius, float vel_value); // third motor
  // bool controlSingleMotor(const float wheel_radius, float value); // third motor
 ...
 private:
  ...
  uint8_t third_motor_id_; //third motor
};
