...
void modulePositionCallback(const std_msgs::Float64MultiArray&  mdl_pos_msg) //Extended Position Mode
{
  ...
  dxl_cur_pos = sr_data[0].present_position;

  sw_data[0].goal_position = dxl_cur_pos + (mdl_pos_msg.data[1] / DYNAMIXEL_DEG_PER_PULSE);
