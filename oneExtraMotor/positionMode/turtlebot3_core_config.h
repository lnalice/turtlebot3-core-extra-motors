...
void modulePositionCallback(const std_msgs::Float64& mdl_pos_msg); //third motor - Extended Position Control mode
...
ros::Subscriber<std_msgs::Float64> module_pos_sub("module_pos", modulePositionCallback); /* third motor [Extended Position Control Mode*/
