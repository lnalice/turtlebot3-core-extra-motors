...
void setup()
{
  ...
  nh.subscribe(module_vel_sub); /* third motor*/
...
void loop()
{
  ...
  { 
    motor_driver.writeSingleVelocity(WHEEL_RADIUS, module_velocity);
  }
...
/*******************************************************************************
* [CUSTOM] Callback function for moduleVelocityCallback msg 
*******************************************************************************/
