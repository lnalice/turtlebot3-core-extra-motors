...
void moduleVelocityCallback(const std_msgs::Float64& mdl_vel_msg); //third motor
...
ros::Subscriber<std_msgs::Float64> module_vel_sub("module_vel", moduleVelocityCallback); /* third motor*/
